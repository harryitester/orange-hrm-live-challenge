...
- Name: TC_LOGIN_NEG_01 - Login with invalid username
- Location: /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:14:5
...
Call log:
  - waiting for locator('[name="username"]').first() to be visible
    ...
    at /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:16:19
```
