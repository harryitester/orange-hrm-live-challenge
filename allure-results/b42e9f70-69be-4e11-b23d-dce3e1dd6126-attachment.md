...
- Location: /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:23:5
...
Call log:
  - waiting for locator('[name="username"]').first() to be visible
    ...
    at /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:25:19
```
