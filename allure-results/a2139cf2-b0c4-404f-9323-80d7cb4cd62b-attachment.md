...
- Name: TC_LOGIN_NEG_02 - Login with invalid password
- Location: /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:22:5
...
Call log:
  - waiting for locator('[name="username"]').first() to be visible
    ...
    at /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:24:19
```
