...
- Name: TC_LOGIN_NEG_03 - Login with empty username
- Location: /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:31:5
...
Call log:
  - waiting for locator('[name="username"]').first() to be visible
    ...
    at /Users/admin/Desktop/automation-challenge/orange-hrm-live-challenge/tests/login/login.spec.ts:33:19
```
